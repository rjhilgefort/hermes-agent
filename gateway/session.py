...
class SessionSource:
    ...
    # True when the adapter granted access using evidence the generic gateway
    # cannot independently re-check, such as a Discord role or an explicitly
    # mentioned allow-listed peer bot.
